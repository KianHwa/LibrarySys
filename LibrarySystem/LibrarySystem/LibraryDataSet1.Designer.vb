...
Partial Public Class LibraryDataSet1
    ...
    Partial Public Class BookDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddBookRow(ByVal bookName As String) As BookRow
            Dim rowBookRow As BookRow = CType(Me.NewRow,BookRow)
            Dim columnValuesArray() As Object = New Object() {bookName}
    ...
    Partial Public Class BorrowDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddBorrowRow(ByVal parentMemberRowByFK_Member_Borrow As MemberRow, ByVal borrowDate As Date) As BorrowRow
            Dim rowBorrowRow As BorrowRow = CType(Me.NewRow,BorrowRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, borrowDate}
            If (Not (parentMemberRowByFK_Member_Borrow) Is Nothing) Then
                columnValuesArray(0) = parentMemberRowByFK_Member_Borrow(0)
            End If
...
Namespace LibraryDataSet1TableAdapters
    ...
    Partial Public Class BookTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT bookName FROM dbo.Book"
    ...
    Partial Public Class BorrowTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT memberID, borrowDate FROM dbo.Borrow"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As LibraryDataSet1.BorrowDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As LibraryDataSet1.BorrowDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As LibraryDataSet1.BorrowDataTable = New LibraryDataSet1.BorrowDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
    End Class
    ...
    Partial Public Class MemberTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Member] WHERE (([memberID] = @Original_memberID))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Member] ([memberID]) VALUES (@memberID);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT memberID FROM"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Member] SET [memberID] = @memberID WHERE (([memberID] = @Original_m"& _ 
                "emberID));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT memberID FROM Member WHERE (memberID = @memberID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT memberID FROM dbo.Member"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
