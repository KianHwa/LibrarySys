...
Partial Public Class Book
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_ISBN", DbType:="VarChar(20) NOT NULL", CanBeNull:=false)>  _
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Book_Borrow", Storage:="_Borrows", ThisKey:="bookID", OtherKey:="bookID")>  _
	Public Property Borrows() As EntitySet(Of Borrow)
		Get
			Return Me._Borrows
		End Get
...
Partial Public Class Borrow
    ...
    Partial Private Sub OnbookIDChanged()
    End Sub
    Partial Private Sub OnborrowDateChanging(value As Date)
    End Sub
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_borrowDate", DbType:="Date NOT NULL")>  _
	Public Property borrowDate() As Date
		Get
			Return Me._borrowDate
		End Get
		Set
			If ((Me._borrowDate = value)  _
						= false) Then
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Book_Borrow", Storage:="_Book", ThisKey:="bookID", OtherKey:="bookID", IsForeignKey:=true)>  _
