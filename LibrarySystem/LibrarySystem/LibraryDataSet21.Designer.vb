...
Namespace LibraryDataSet2TableAdapters
    ...
    Partial Public Class BookTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Borrow.borrowDate, Borrow.memberID, Book.bookName"&Global.Microsoft.VisualBasic.ChrW(10)&"FROM     Borrow CROSS JO"& _ 
                "IN"&Global.Microsoft.VisualBasic.ChrW(10)&"                  Book"
    ...
    Partial Public Class BorrowTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Borrow] ([memberID], [ISBN], [borrowDate], [returnDate], [stat"& _ 
                "us]) VALUES (@memberID, @ISBN, @borrowDate, @returnDate, @status);"&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT borrow"& _ 
                "ID, memberID, ISBN, borrowDate, returnDate, status FROM Borrow WHERE (ISBN = @IS"& _ 
                "BN) AND (borrowID = SCOPE_IDENTITY()) AND (memberID = @memberID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Borrow] SET [memberID] = @memberID, [ISBN] = @ISBN, [borrowDate] = "& _ 
                ...
                " IS NULL) OR ([status] = @Original_status)));"&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT borrowID, memberID, ISBN, b"& _ 
                "orrowDate, returnDate, status FROM Borrow WHERE (ISBN = @ISBN) AND (borrowID = @"& _ 
    ...
    Partial Public Class MemberTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Member] ([memberID], [memberName]) VALUES (@memberID, @memberN"& _ 
                "ame);"&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT memberID, memberName FROM Member WHERE (memberID = @memberID)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@memberID", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "memberID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Member] SET [memberID] = @memberID, [memberName] = @memberName WHER"& _ 
                ...
                "e] IS NULL) OR ([memberName] = @Original_memberName)));"&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT memberID, memberN"& _ 
                "ame FROM Member WHERE (memberID = @memberID)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@memberID", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "memberID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
