...
Namespace LibraryDataSet1TableAdapters
    ...
    Partial Public Class MemberTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Member] ([memberID]) VALUES (@memberID);"&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT memberID FROM "& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Member] SET [memberID] = @memberID WHERE (([memberID] = @Original_m"& _ 
                "emberID));"&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT memberID FROM Member WHERE (memberID = @memberID)"
